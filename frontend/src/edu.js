...
const SYNDROMES = [
  ...
  { name: 'Trisomi 8 Mosaik', aka: 'Warkany Syndrome 2', chr: '8', type: 'mosaik', kar: '46/47,+8 [mosaik]', inc: '1/30.000', via: 'viable', nd: 'Mitosis post-zigot', age: 'Lemah', feat: 'Kelainan muskuloskeletal, wajah khas, disabilitas intelektual ringan-sedang, stenosis ureter', desc: 'Trisomi 8 penuh tidak viable. Bentuk mosaik memungkinkan bertahan dengan gejala variabel.', ac: '#c2410c', featured: false },
  { name: 'Trisomi 9 Mosaik', aka: 'Trisomi 9 Parsial', chr: '9', type: 'mosaik', kar: '46/47,+9 [mosaik]', inc: '1/40.000', via: 'jarang', nd: 'Mitosis post-zigot', age: 'Lemah', feat: 'Kelainan otak, defek jantung, dismorfisme wajah, kelainan tulang', desc: 'Sangat jarang. Prognosis tergantung persentase sel aneuploid.', ac: '#b91c1c', featured: false },
  { name: 'Trisomi 20 Mosaik', aka: 'Mosaik Trisomi 20', chr: '20', type: 'mosaik', kar: '46/47,+20 [mosaik]', inc: '1/50.000', via: 'viable', nd: 'Mitosis post-zigot', age: 'Lemah', feat: 'Sering ditemukan prenatal; fenotip sering normal atau sangat ringan', desc: 'Sering ditemukan saat amniosentesis tanpa tanda klinis nyata.', ac: '#15803d', featured: false },
  { name: 'Trisomi 22 Mosaik', aka: 'Mosaik Trisomi 22', chr: '22', type: 'mosaik', kar: '46/47,+22 [mosaik]', inc: '1/25.000', via: 'jarang', nd: 'Mitosis post-zigot', age: 'Lemah', feat: 'Kelainan kraniofasial, defek jantung, disabilitas intelektual', desc: 'Prognosis bervariasi tergantung proporsi sel aneuploid.', ac: '#047857', featured: false },
